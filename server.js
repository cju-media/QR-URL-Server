        ...
        res.end(`
            ...
            <head>
                ...
                <style>
                    ...
                    .card { background: white; padding: 25px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); width: 100%; max-width: 400px; position: relative; }
...
server.listen(3000, '0.0.0.0', () => console.log('Server Active. UI Status badge added.'));